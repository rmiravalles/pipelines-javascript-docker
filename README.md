...
MS Learn tutorial: [Build and deploy to AKS with Azure pipelines](https://learn.microsoft.com/en-us/azure/aks/devops-pipeline?view=azure-devops&tabs=cli&pivots=pipelines-yaml)
